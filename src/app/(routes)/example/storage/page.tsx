...
export default function StorageExamplePage() {
	...
	return (
		<div className="mx-auto max-w-4xl p-6">
			...
			{/* 입력 필드 */}
			<div className="mb-8 rounded-lg bg-slate-100 p-4 dark:bg-slate-800">
				...
				<div className="mb-2 flex gap-4">
					<div className="flex-1">
						...
						<input
							...
							className="w-full rounded border p-2 dark:border-slate-600 dark:bg-slate-700 dark:text-white"
						/>
					</div>
					<div className="flex-1">
			...
			{/* 쿠키 섹션 */}
			<div className="mb-8 rounded-lg border p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
				<h2 className="mb-4 text-2xl font-semibold">쿠키 (Cookie)</h2>

				<div className="mb-4 grid grid-cols-2 gap-2">
					<button
						onClick={handleSetCookie}
						className="rounded bg-green-500 p-2 text-white hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700"
					>
						저장
					</button>
					<button
						onClick={handleGetCookie}
						className="rounded bg-blue-500 p-2 text-white hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700"
					>
						조회
					</button>
					<button
						onClick={handleCheckCookie}
						className="rounded bg-yellow-500 p-2 text-white hover:bg-yellow-600 dark:bg-yellow-600 dark:hover:bg-yellow-700"
					>
						확인
					</button>
					<button
						onClick={handleDeleteCookie}
						className="rounded bg-red-500 p-2 text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700"
					>
						삭제
					</button>
				</div>

				<div className="mb-4 min-h-[40px] rounded bg-gray-100 p-3 dark:bg-slate-700">
					<p className="dark:text-white">{cookieResult}</p>
				</div>

				<div>
					<h3 className="mb-2 font-medium">저장된 쿠키 목록</h3>
					<div className="max-h-[200px] overflow-auto rounded border p-2 dark:border-slate-600 dark:bg-slate-700">
						{cookieItems.length > 0 ? (
							<ul>
								{cookieItems.map((item, idx) => (
									<li
										key={idx}
										className="mb-1 border-b pb-1 dark:border-slate-600 dark:text-white"
									>
			...
			<div className="mb-8 rounded-lg border p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
				...
				<div className="mb-4 min-h-[40px] rounded bg-gray-100 p-3 dark:bg-slate-700">
					<p className="dark:text-white">{localResult}</p>
				</div>
			...
			<div className="mb-8 rounded-lg border p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
				...
				<div className="mb-4 min-h-[40px] rounded bg-gray-100 p-3 dark:bg-slate-700">
					<p className="dark:text-white">{sessionResult}</p>
				</div>
			...
			<div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-900">
				...
				<ul className="list-disc space-y-1 pl-5 dark:text-white">
					<li>
